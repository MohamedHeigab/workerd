...
// =============================================================================
// custom_trace — user-written GarbageCollected impl
// =============================================================================
...
/// The user provides their own `GarbageCollected` impl with custom logic.
...
// User-supplied GarbageCollected impl — not generated by the macro because of custom_trace.
impl jsg::GarbageCollected for CustomTraceParent {
    fn trace(&self, visitor: &mut jsg::GcVisitor) {
        visitor.visit_rc(&self.child);
    }
...
/// With `custom_trace`, the user-supplied `GarbageCollected` impl is used and
