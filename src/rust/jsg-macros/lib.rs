...
/// Use `#[jsg_struct(name = "MyName")]` to override the JavaScript class name.
...
/// `jsg::GarbageCollected`. The `GarbageCollected::trace` body is generated
/// automatically for all traceable fields (see `trace.rs` for the full matrix).
///
