...
mod tests {
    ...
    // extract_name_attribute takes proc_macro::TokenStream, which cannot be
    // constructed outside a live proc-macro invocation (the bridge panics).
    // Its behaviour is covered by the jsg-test integration tests.
